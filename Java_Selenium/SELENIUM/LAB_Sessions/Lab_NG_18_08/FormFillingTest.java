...
public class FormFillingTest {
    ...
    public void fillForm() throws InterruptedException {
        ...
        // 1. First Name
        driver.findElement(By.xpath("//input[@name='firstname']")).sendKeys("Saswat");
        Thread.sleep(delay);

        // 2. Last Name
        driver.findElement(By.xpath("//input[@name='lastname']")).sendKeys("Pati");
        Thread.sleep(delay);
        ...
        // 6. Profession Checkboxes (Automation Tester)
        driver.findElement(By.xpath("//input[@id='profession-1']")).click();
        Thread.sleep(delay);

        // 7. Tool Checkbox (Selenium Webdriver)
        driver.findElement(By.xpath("//input[@id='tool-2']")).click();
        Thread.sleep(delay);

        // 8. Continents Dropdown (Europe)
        ...
        // 9. Selenium Commands (Browser Commands & Navigation Commands)
