...
public class ShoppingCartAutomation {
    ...
    public void goToCartAndCheckout() throws InterruptedException {
        ...
        WebElement product = driver.findElement(By.xpath("//td[contains(text(),'Samsung galaxy s6')]"));
        if (product.isDisplayed()) {
            System.out.println("✅ Product visible in cart.");
        } else {
        ...
        // Fill Order Form
        System.out.println("➡ Step 5: Filling order form...");
        ...
        driver.findElement(By.xpath("//input[@id='card']")).sendKeys("1234 5678 9012 3456");
        Thread.sleep(2000);

        driver.findElement(By.xpath("//input[@id='month']")).sendKeys("08");
        Thread.sleep(2000);

        driver.findElement(By.xpath("//input[@id='year']")).sendKeys("2028");
        Thread.sleep(2000);
